...
import IncludedFee from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentPrices/UpdateIncludedFee';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Phí dịch vụ dài hạn</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <IncludedFee />
