...
import PriceShortTerm from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentPrices/UpdatePriceShortTerm';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Giá ngắn hạn</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <PriceShortTerm />
