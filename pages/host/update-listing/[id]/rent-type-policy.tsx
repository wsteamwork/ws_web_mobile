...
import RentTypePolicy from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentPolicy/UpdateRentTypePolicy';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Chính sách đặt phòng</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <RentTypePolicy />
