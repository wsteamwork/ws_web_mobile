...
import BookingPolicy from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentPolicy/UpdateBookingPolicy';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Hình thức đặt phòng</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <BookingPolicy />
