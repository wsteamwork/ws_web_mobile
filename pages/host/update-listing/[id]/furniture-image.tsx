...
import FurnitureImage from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentImages/UpdateFurnitureImage';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Ảnh nội thất</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <FurnitureImage />
