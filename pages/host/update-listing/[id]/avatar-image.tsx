...
import AvatarImage from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentImages/UpdateAvatarImage';
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={5} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Ảnh đại diện</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <AvatarImage />
