...
import PriceWeekday from '@/components/LTR/Merchant/Listing/UpdateListing/UpdateComponentPrices/UpdatePriceWeekday';
  ...
  return (
    <Fragment>
      ...
      <Grid container justify="center" alignContent="center">
        <Grid item xs={11} sm={9} md={7} lg={6} className={classes.marginLabel}>
          <Breadcrumbs
            ...
            <Typography color="textPrimary">Giá cuối tuần</Typography>
          </Breadcrumbs>
        </Grid>
      </Grid>
      <PriceWeekday />
