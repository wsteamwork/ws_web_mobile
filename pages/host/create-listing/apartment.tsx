...
import { CreateApartmentState, handleCreateBuilding } from '@/store/Redux/Reducers/LTR/CreateListing/Basic/CreateApartment';
...
const CreateApartment: FC<IProps> = (props) => {
  ...
  const CreateBuilding: any = () => {
    const res = handleCreateBuilding({
      avatar: avatar,
      name: name,
      name_en: name_en,
      address: address,
    ...
    if (res) {
      ...
      setMessageSnack('Tạo mới tòa nhà thất bại !');
    }
  };
